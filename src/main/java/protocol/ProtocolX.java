...
public class ProtocolX {
	...
	public final static byte NetTypeSF6 = 0x02;// FS6、硅油 网关类型
	public final static byte NetTypeWD = 0x03;// 温度 网关类型

	public final static byte UnitTypeSF6 = 0x01;// SF6 单元类型
	public final static byte UnitTypeSSJ = 0x02;// 硅油 单元类型
	...
	public final static byte LenDataT = 0x07;// 数据应答 长度
	public final static byte LenSetR = 0x03;// 设置应答 长度
	public final static byte LenSetT = 0x05;// 设置 长度
