...
public class System2User extends JPanel {
    ...
    private JButton deleteUser, changeUser, refreshUser;
    ...
    private void initialize() {
        ...
        JButton addUser = new MyButton3("添加", new ImageIcon("images/add.png"));
        ...
        changeUser = new MyButton3("更改", new ImageIcon("images/change.png"));
        ...
        //删除用户:将用户删除
        deleteUser = new MyButton3("删除", new ImageIcon("images/delete.png"));
        ...
        refreshUser = new MyButton3("刷新", new ImageIcon("images/refresh.png"));
        ...
        apply = new MyButton3("确认", new ImageIcon("images/apply.png"));
        apply.setName("确认");
    ...
    static Dimension labelSize = new Dimension(100, 100);
