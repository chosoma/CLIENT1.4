 ...
 * 修改密码 子面板
 */
class System2PassWord extends JPanel {

	private JLabel jlR31, jlR32, jlR33;
	private JPasswordField jpfR31, jpfR32, jpfR33;
	private JButton jbR31, jbR32;
	...
	private void initialize() {
		jlR31 = new JLabel("当前密码:", JLabel.RIGHT);
		...
		jlR32 = new JLabel("新密码:", JLabel.RIGHT);
		...
		jlR33 = new JLabel("确认新密码:", JLabel.RIGHT);
		...
		jbR31 = new MyButton2("确定", new ImageIcon("images/apply.png"));
		jbR31.setBounds(130, 200, 100, 30);
		jbR31.addActionListener(e -> {
            ...
            String password3 = new String(jpfR33.getPassword())
                    .toLowerCase();
            // 做个密码框是不是都有输入
            if (MyUtils.isNull(password1) || MyUtils.isNull(password2)
                    || MyUtils.isNull(password3)) {
		...
		jbR32 = new MyButton2("取消", new ImageIcon("images/cancel.png"));
		jbR32.setBounds(260, 200, 100, 30);
		jbR32.addActionListener(arg0 -> {
            jpfR31.setText(null);
            jpfR32.setText(null);
            jpfR33.setText(null);
        });
