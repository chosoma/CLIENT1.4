...
public class DefaultUIManager {
    ...
    public DefaultUIManager() {
        icons = new ArrayList<>();
        icons.add(new ImageIcon(("com\\tek16.png")).getImage());
        icons.add(new ImageIcon(("com\\tek24.png")).getImage());
        icons.add(new ImageIcon(("com\\tek32.png")).getImage());
        icons.add(new ImageIcon(("com\\tek48.png")).getImage());
        ...
        UIManager
                .put("CheckBoxMenuItemUI", "mytools.menu.MyCheckBoxMenuItemUI");

        UIManager.put("RadioButtonMenuItemUI",
                "mytools.menu.MyRadioButtonMenuItemUI");
    ...
    private void setColor() {
        ...
        // UIManager.put("Button.darkShadow", Color.yellow);
        // UIManager.put("Button.shadow", Color.white);
        UIManager.put("ToolTip.background", Color.white);
        UIManager.put("Panel.background", MyUtil.CONTENT_COLOR);
        UIManager.put("OptionPane.background", MyUtil.CONTENT_COLOR);
        UIManager.put("SplitPane.background", MyUtil.CONTENT_COLOR);
        UIManager.put("Viewport.background", MyUtil.CONTENT_COLOR);
        UIManager.put("ScrollPane.background", MyUtil.CONTENT_COLOR);
        ...
        UIManager.put("RadioButton.disabledText",
                MyUtil.InactiveControlTextColor);
        ...
        UIManager.put("FormattedTextField.inactiveForeground",
                MyUtil.InactiveControlTextColor);
