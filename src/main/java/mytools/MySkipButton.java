...
public class MySkipButton extends JButton {
    ...
    public MySkipButton(Icon icon) {
        super(icon);
    }

    public MySkipButton(Icon icon, boolean selected) {
        super(icon);
        model.setSelected(selected);
    }

    public MySkipButton(String text) {
        super(text);
    }

    public MySkipButton(String text, boolean selected) {
        super(text);
        model.setSelected(selected);
    }
    ...
    public MySkipButton(String text, Icon icon, int type) {
        super(text, icon);
        this.type = type;
    ...
    public MySkipButton(String text, Icon icon, boolean selected) {
        super(text, icon);
        model.setSelected(selected);
    }
